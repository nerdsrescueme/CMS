...
<head>
	...
	<meta name="description" content="Based on more than two decades of experience with the DISC styles, Take Flight Learning was founded to share DISC with the world. Offering a variety of DISC training programs, products, and services.">
	<meta content="keywords" content="DISC Styles, behavioral profile, personality profiles, disc training, take flight learning, Taking Flight with DISC, Taking Flight">
	<?php else : ?>
	...
	<div id="slider" class="span12 carousel slide">
		<div class="carousel-inner">
			<div class="item active">
				<a href="/book"><img src="/themes/takingflight/assets/img/marketing/book.png"></a>
			</div>
			<div class="item">
				<a href="/taking-flight-profile"><img src="/themes/takingflight/assets/img/marketing/birds.png"></a>
			</div>
			<div class="item">
				<a href="/speaking"><img src="/themes/takingflight/assets/img/marketing/speaking.png"></a>
			</div>
			<div class="item">
				<a href="/training"><img src="/themes/takingflight/assets/img/marketing/click.png"></a>
			</div>
		</div>
	</div>
	<?php endif ?> 
