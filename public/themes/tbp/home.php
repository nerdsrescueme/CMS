...
<section id="features" class="row">
	<div class="span3"><div data-editable="global">
...
<section id="recent" class="row">
	<div id="event" class="span6" data-editable="global">
...
<section id="choose" class="row" data-editable="local">
	...
	<div class="span6">
		...
		<ol id="tweets">
			<li><a href="#"><time>about 26 minutes ago</time></a> This is one of my 140 character tweets from Twitter!</li>
			<li><a href="#"><time>about 18 minutes ago</time></a> I just posted this fantastic link up, check it out. <a href="#">#links</a></li>
			<li><a href="#"><time>about 2 minutes ago</time></a> This is one of my 140 character tweets from Twitter! Just needs to be a little bit longer.</li>
		</ol>
	</div>
</section>
