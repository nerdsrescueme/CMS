...
<?php echo Form::hidden('parent_id', Input::post('parent_id', isset($link) ? $link->parent_id : '')); ?>
	<fieldset>
		<div class="clearfix">
			<?php echo Form::label('Link Group', 'link_group_id'); ?>
			<div class="input">
				<?php echo Form::select('link_group_id', isset($link) ? $link->link_group_id : $group, $groups) ?>
			</div>
		</div>
		<div class="clearfix">
